      ...
      <Main>
        <article className="space-y-3 text-lg">
          <p>
            ...
            or will be submitted to another journal, conference or workshop
            during the review period. In such a case, the paper will be rejected
            without review.
          </p>
          <p>
          ...
          <p>
            ...
            all text, figures, and references). The manuscript must be submitted
          ...
          <p>
            ...
            (i.e., an alpha-channel of a transparent color) since this could
            lead to problems when displaying or printing the pdf.
          </p>
          <p>
